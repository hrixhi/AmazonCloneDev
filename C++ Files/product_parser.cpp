...
{
 Product* bookptr = new Book("book", prodName_, price_, qty_, 
    author_, isbn_);
 return bookptr;
}
...
Product* ProductClothingParser::makeProduct()
{
    ...
    Product* clothingptr = new Clothing("clothing", prodName_, price_, 
        qty_, size_, brand_);
    return clothingptr;
...
{
    Product* movieptr = new Movie("movie", prodName_, price_, qty_, 
        genre_, rating_);
    return movieptr;
